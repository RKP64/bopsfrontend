              ...
              {chatHistory.length === 0 && !isLoading ? (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', textAlign: 'center' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', width: '100%', maxWidth: '800px' }}>
                    <button className="predefined-question-btn" onClick={() => handleSubmit("What are the peak congestion hours for departure entry at Terminal 1 versus Terminal 2 at BIAL airport?")} style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      textAlign: 'center',
                    }}>What are the peak congestion hours for Departure Entry at Terminal 1 versus Terminal 2</button>
                    <button className="predefined-question-btn" onClick={() => handleSubmit("Compare the ratio of Aerobridge vs. Bus boarding usage between Domestic and International operations at Terminal 2 of the BIAL airport?")} style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      textAlign: 'center',
